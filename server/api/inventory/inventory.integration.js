...
describe('Inventory API:', function() {
    ...
    it('should respond with the updated inventory on a subsequent GET', function(done) {
      request(app)
        ...
        .end((err, res) => {
          ...
          inventory.name.should.equal('Updated Inventory');
          inventory.info.should.equal('This is the updated inventory!!!');
  ...
  describe('PATCH /api/inventorys/:id', function() {
    ...
    beforeEach(function(done) {
      request(app)
        .patch(`/api/inventorys/${newInventory._id}`)
        .send([
    ...
    it('should respond with the patched inventory', function() {
      patchedInventory.name.should.equal('Patched Inventory');
      patchedInventory.info.should.equal('This is the patched inventory!!!');
    });
  });
