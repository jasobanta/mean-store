...
describe('Upload API:', function() {
    ...
    it('should respond with the updated upload on a subsequent GET', function(done) {
      request(app)
        ...
        .end((err, res) => {
          ...
          upload.name.should.equal('Updated Upload');
          upload.info.should.equal('This is the updated upload!!!');
  ...
  describe('PATCH /api/uploads/:id', function() {
    ...
    it('should respond with the patched upload', function() {
      patchedUpload.name.should.equal('Patched Upload');
      patchedUpload.info.should.equal('This is the patched upload!!!');
    });
  });
